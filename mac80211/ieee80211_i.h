...
struct ieee80211_sub_if_data {
	...
	unsigned long state;
        ...
        int drop_next;
        int nr_packets;
        struct timeval past_packet_times[2000];
        int past_packet_delivered[2000];
        int start, end;
        int loss_rate;
...
/* [VD]: merged from AC */
#ifdef WIFI_MOBILITY
void ieee80211_offchannel_ps_enable(struct ieee80211_sub_if_data *sdata);
void ieee80211_offchannel_ps_disable(struct ieee80211_sub_if_data *sdata);
#endif
...
void ap_switch_notify_assoc(struct ieee80211_sub_if_data *);
void ap_switch_notify_disassoc(struct ieee80211_sub_if_data *);
void ap_switch_change_channel(struct ieee80211_sub_if_data *,
                int, int, int);
